...
var myApp = angular.module('TaskApp', ['myFilters']);

// myApp.config(dannzzorPageRoute);
...
myApp.controller('ctrlTask', function ($scope, $filter, $http) {
  ...
  $scope.snippets = [
    ...
    {name:'snippet16', code:'partials/snippets/snippet016.html'},
    {name:'snippet17', code:'partials/snippets/snippet017.html'},
